...
class Fgcfc {
    ...
    function fgcfc_table_install() {
        global $wpdb;
        $sql = "CREATE TABLE " . Fgcfc::$table_name . " (
    ...
    static function fgcfc_show_form() {
        ...
        <div class="fgcf_contact_form" id="fgcf_content_wraper">
            ...
            <div class="fgcf_form_heading"><h1>Contact Form</h1></div>
            <div class="fgcf_form_outer_div" id="fgcf_form_outer_div">
                <form action="" method="post">
                    <div id="name_wraper" class="name_wraper">
                        <p class="fgcf_form_name" id="form_name">
                            <label for="fgcf_form_name" id="fgcf_form_name">  Name </label></br>
                            <input type="text" name="fgcf_form_name" id="fgcf_form_name" value="" />
                        </p>
                    </div>
                    <div id="email_wraper" class="email_wraper">
                        <p class="fgcf_form_email" id="fgcf_form_email">
                            <label for="fgcf_form_email" id="fgcf_form_email"> Email</label></br>
                            <input type="text" name="fgcf_form_email" id="fgcf_form_email" value="" />
                        </p>
                    </div>
                    <div id="subject_wraper" class="subject_wraper">
                        <p class="fgcf_form_subject" id="fgcf_form_subject">
                            <label for="fgcf_form_subject" id="fgcf_form_subject">Subject</label></br>
                            <input type="text" name="fgcf_form_subject" id="fgcf_form_subject" value="" />
                        </p>
                    </div>
                    <div id="message_wraper" class="message_wraper">
                        <p class="fgcf_form_message" id="fgcf_form_message">
                            <label for="fgcf_form_message" id="fgcf_form_message"> Message</label></br>
                            <textarea name="fgcf_form_message" id="fgcf_form_messages" cols="35" rows="5" value="" ></textarea>
                        </p>
                        <p id="submit_wrapper">
