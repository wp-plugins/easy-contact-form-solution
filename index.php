    ...
    if ($pos == false) {
        ...
        <div class="contac_us_img" style="display:none"><img src="<?php echo plugins_url('/image/contact-button.png', __FILE__); ?>" > </div>
            <div id="fgcf-box-popup" style="display:none">
                <div id="fg_form_show" > 
				<div class="formget_form" style="height:500px; overflow-Y: scroll;"><div id="fg_close" ><img class="close_popup" src="<?php echo $close_image_path; ?>"/></div><?php echo stripslashes($fg_iframe_form); ?></div><p>Powered by <a herf="formget.com">FormGet- Online Form Builder
</a> </p></div>
            </div>
            <?php
    } else {
       function tabbed_embeded_code() {
        ...
        add_action('wp_head', tabbed_embeded_code);
            ...
            ?>
				<div class="contac_us_img" style="display:none"><img src="<?php echo plugins_url('/image/contact-button.png', __FILE__); ?>" > </div>
            <div id="fgcf-box-popup"  style="display:none">
                <div id="fg_form_show"><div class="fgcf_form"> <?php echo Fgcfc::fgcfc_show_form(); ?></div><p id="link_to_formget">Powered by  <a href="http://www.formget.com/" target="_blank"> FormGet- Online Form Builder </a></p></div>
            </div>
            <?php
        }
    }
