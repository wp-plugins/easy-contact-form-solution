    ...
    if ($pos == false) {
        ...
        <div class="contac_us_img" style="display:none"><img src="<?php echo plugins_url('/image/contact-button.png', __FILE__); ?>" > </div>
            <div id="fgcf-box-popup" style="display:none">
                <div id="fg_form_show" > 
				<div class="formget_form" style="height:500px; overflow-Y: scroll;"><div id="fg_close" ><img class="close_popup" src="<?php echo $close_image_path; ?>"/></div><?php echo stripslashes($fg_iframe_form); ?></div></div>
            </div>
            <?php
    } else {
