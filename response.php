...
function Fgcfc_setting_page() {
    ...
    <div class="whole_div" id="whole_div">
		...
		<div id="example_container" class="example_iframe_div" >
            <iframe src="http://www.formget.com/form-templates/" name="iframe" id="example_iframe" width="99%" height="700px">
            </iframe>
        </div>
        <div id="embed_advance_form_div" class="embed_advance_form_div" >
            <div class="embed_section"><p> <h3>Create your form and save it, after saving you will get an embed code.</br>Paste here your Sliding form code or Embed Full Form(2 PLAIN FORM) code by copying it, and then click on save button. </h3> </p>
                <h1>Embed Code</h1>
				...
				<?php  $load_img_path = plugins_url('/image/load1.gif', __FILE__); ?>
				 <div id="dvLoading" style='display:none'><img src="<?php echo $load_img_path; ?>"/></div>
